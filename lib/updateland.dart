...
class _UpdateLandPageState extends State<UpdateLandPage> {
  ...
  void _initializeData() {
    _areaController.text = widget.initialLandData["area"]?.toString() ??
        ""; // Ensure string format
    _specificAreaController.text =
        widget.initialLandData["specificArea"]?.toString() ?? "";
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: _selectedImage == null
            ? Image.asset(
                "image/defaultland.png", // Default image path
                fit: BoxFit.cover,
              )
            : Image.file(
                ...
                onPressed: () {
                  ...
                  final updatedLand = {
                    ...
                    "image": _selectedImage?.path ??
                        "image/defaultland.png", // Default fallback image
                  };
