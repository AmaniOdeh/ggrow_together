...
class _UpdateLandPageState extends State<UpdateLandPage> {
  ...
  void _loadInitialData() {
    final data = widget.initialLandData;
    ...
    setState(() {
      ...
      if (data["location"] != null) {
        if (data["location"] is LatLng) {
          ...
          final latitude = locationMap["latitude"] ?? 0.0;
          final longitude = locationMap["longitude"] ?? 0.0;
      ...
      _townController.text = data["townOrVillage"] ?? "";
      _streetController.text = data["streetName"] ?? "";
      _selectedImage = data["image"] != null ? XFile(data["image"]) : null;
    });
  }
