...
import 'myservicelandowner.dart';
import 'myworkerlandowner.dart';
          ...
          IconButton(
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => MessagingHomePage(),
                ),
              );
            },
          ),
      ...
      child: Card(
        ...
        child: Container(
          ...
          padding: const EdgeInsets.symmetric(
              horizontal: 40, vertical: 10), // توسيع الحواف
          child: Column(
            children: [
              Text(
                "!مرحباً بك\nقم بإدارة أراضيك وعمالك\nوإعلاناتك بكل سهولة",
                style: GoogleFonts.arefRuqaa(
                  ...
                  shadows: const [
                    Shadow(
                      offset: Offset(1, 1), // تأثير الظل
                      blurRadius: 2,
                      color: Colors.black26, // لون الظل رمادي خفيف
                    ),
                  ],
                ),
    ...
    final List<Map<String, dynamic>> dashboardItems = [
      {
        ...
        "onTap": () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => const LandListPage(
                username: 'ExampleUser',
              ), // الانتقال إلى صفحة MyLandsPage
            ),
          );
        },
      },
      {
        "title": "أراضي للبحث عن عمال",
      ...
      {
        "title": "أراضي للبحث عن ضامن", // تعديل العنوان
      ...
      {
        "title": "التحليل",
        "icon": Icons.camera_alt, // أيقونة الكاميرا
        "color": const Color(0xFF66BB6A),
        "onTap": () {},
      },
      {
        ...
        "onTap": () {
          Navigator.push(
              ...
              MaterialPageRoute(
                builder: (context) =>
                    LandServiceProvidersPage(), // الانتقال إلى صفحة MyLandsPage
              ));
        },
      },
      {
        ...
        "onTap": () {
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (context) =>
                  LandWorkersPage(), // الانتقال إلى صفحة MyLandsPage
            ),
          );
        },
      },
