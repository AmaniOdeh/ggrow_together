                  ...
                  child: ListTile(
                    ...
                    subtitle: Column(
                      ...
                      children: [
                        Text(ad["description"]),
                        if (ad["type"] == "Owner") ...[
                          // Details specific to "Owner"
                          Text("Area: ${ad["area"]} km²"),
                          Text("Location: ${ad["location"]}"),
                        ],
                        if (ad["type"] == "Service Provider") ...[
                          // Details specific to "Service Provider"
                          Text("Service Type: ${ad["serviceType"]}"),
                          Text("Discount Price: ${ad["discountPrice"]}"),
                        ],
                      ],
                    ),
                    trailing: IconButton(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            if (advertisement["type"] == "Owner") ...[
              Text("Area: ${advertisement["area"]} km²"),
              Text("Location: ${advertisement["location"]}"),
            ],
            if (advertisement["type"] == "Service Provider") ...[
              Text("Service Type: ${advertisement["serviceType"]}"),
              Text("Discount Price: ${advertisement["discountPrice"]}"),
            ],
